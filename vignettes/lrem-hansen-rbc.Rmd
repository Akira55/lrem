...
Gary Hansen's (1985) RBC model is characterized by 
...
\begin{aligned}
  ...
  q_{0}\\
  1
  \end{bmatrix}\hat{z}_{t}
\end{aligned}
$$
with
$$
  \hat{z}_{t+1}=\rho\hat{z}_{t}+\epsilon_{t+1},
$$
where 

$$
\hat{K}_{t}:=dK_{t}/\bar{K},\ \hat{z}_{t}:=dz_{t}/\bar{z},\ 
\hat{C}_{t}:=dC_{t}/\bar{C},\ \hat{N}_{t}:=dN_{t}/\bar{N}
$$
